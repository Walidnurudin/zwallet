...
export default function Home() {
  ...
  return (
    <div style={{ background: "rgba(99, 121, 244, 0.2)" }}>
      {/* HEADER */}
      <section
        className="container d-flex justify-content-between"
        style={{ padding: "50px 0px" }}
      >
        <img src="../assets/images/logo/zwallet.png" alt="logo" width="98px" />
      ...
      >
        <div className="container d-flex align-items-center flex-md-row flex-column gap-5">
          <img
